...
var bundleApplication = function () {
    return Q.all([
        ...
        bundle(srcDir.path('connectSocket.js'), destDir.path('connectSocket.js')),
        bundle(srcDir.path('manageMQTT.js'), destDir.path('manageMQTT.js')),
        bundle(srcDir.path('connectGPS.js'), destDir.path('connectGPS.js')),
        bundle(srcDir.path('connectMQTT.js'), destDir.path('connectMQTT.js')),
        bundle(srcDir.path('trackBus.js'), destDir.path('trackBus.js')),
        bundle(srcDir.path('cacheTest.js'), destDir.path('cacheTest.js'))
    ]);
};
